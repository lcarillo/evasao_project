"""
Django settings for evasao_project project.
"""
...
ALLOWED_HOSTS = [
    'evasao-project.onrender.com',  # Seu domínio no Render
    'localhost',
    '127.0.0.1',
]

# Adicionar host do Render dinamicamente
...
ROOT_URLCONF = 'evasao_project.urls'
...
WSGI_APPLICATION = 'evasao_project.wsgi.application'
